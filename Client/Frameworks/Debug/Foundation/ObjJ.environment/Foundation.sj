...
p;23;CPComparisonPredicate.jt;17371;@STATIC;1.0;i;9;CPArray.ji;8;CPNull.ji;10;CPString.ji;14;CPEnumerator.ji;13;CPPredicate.ji;14;CPExpression.jt;17255;
...
p;21;CPCompoundPredicate.jt;7170;@STATIC;1.0;i;13;CPPredicate.jI;20;Foundation/CPArray.jI;21;Foundation/CPString.jt;7082;
...
p;24;CPExpression_aggregate.jt;3899;@STATIC;1.0;i;14;CPExpression.jI;20;Foundation/CPArray.jI;21;Foundation/CPString.jt;3810;
...
p;23;CPExpression_constant.jt;2889;@STATIC;1.0;i;14;CPExpression.jI;25;Foundation/CPDictionary.jt;2821;
...
p;23;CPExpression_function.jt;10326;@STATIC;1.0;i;14;CPExpression.jI;21;Foundation/CPString.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jt;10206;
...
},["id","CPExpression",null,null]), new objj_method(sel_getUid("isEqual:"), function $CPExpression_function__isEqual_(self, _cmd, object)
{ with(self)
{
    if (self == object)
        return YES;
...
{ with(self)
{
    var result = _operand + objj_msgSend(self, "_function") + "(";
...
{ with(self)
{
    var target = objj_msgSend(coder, "decodeObjectForKey:", CPOperandKey),
        selector = CPSelectorFromString(objj_msgSend(coder, "decodeObjectForKey:", CPSelectorNameKey)),
        arguments = objj_msgSend(coder, "decodeObjectForKey:", CPArgumentsKey);

    return objj_msgSend(self, "initWithTarget:selector:arguments:", target, selector, arguments);
}
...
},["int","int"]), new objj_method(sel_getUid("modulus:by:"), function $CPPredicateUtilities__modulus_by_(self, _cmd, n, n)
{ with(self)
{
    return n % m;
}
...
p;22;CPExpression_keypath.jt;1899;@STATIC;1.0;i;14;CPExpression.jI;21;Foundation/CPString.jI;29;Foundation/CPKeyValueCoding.ji;23;CPExpression_function.jt;1773;
...
{ with(self)
{
    ...
    self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("CPExpression_keypath").super_class }, "initWithTarget:selector:arguments:", operand, sel_getUid("valueForKeyPath:"), [arg]);

    return self;
}
},["id","CPExpression","CPString"]), new objj_method(sel_getUid("pathExpression"), function $CPExpression_keypath__pathExpression(self, _cmd)
{ with(self)
{
...
{ with(self)
{
    return objj_msgSend(objj_msgSend(self, "pathExpression"), "constantValue");
}
},["CPString"]), new objj_method(sel_getUid("description"), function $CPExpression_keypath__description(self, _cmd)
{ with(self)
{
    return objj_msgSend(self, "keyPath");
}
},["CPString"])]);
}

p;19;CPExpression_self.jt;1994;@STATIC;1.0;i;14;CPExpression.jI;21;Foundation/CPString.jI;25;Foundation/CPDictionary.jI;20;Foundation/CPCoder.jt;1875;
...
},["id","id","CPDictionary"]), new objj_method(sel_getUid("_expressionWithSubstitutionVariables:"), function $CPExpression_self___expressionWithSubstitutionVariables_(self, _cmd, variables)
{ with(self)
{
    return self;
}
...
p;18;CPExpression_set.jt;5220;@STATIC;1.0;i;14;CPExpression.jt;5182;
...
{ with(self)
{
    ...
    return objj_msgSend(CPExpression, "expressionForConstantValue:", result);
}
...
p;23;CPExpression_variable.jt;3128;@STATIC;1.0;i;14;CPExpression.jI;21;Foundation/CPString.jI;25;Foundation/CPDictionary.jt;3034;
...
p;13;CPPredicate.jt;31551;@STATIC;1.0;I;20;Foundation/CPValue.jI;20;Foundation/CPArray.jI;18;Foundation/CPSet.jI;19;Foundation/CPNull.jI;22;Foundation/CPScanner.ji;21;CPCompoundPredicate.ji;23;CPComparisonPredicate.ji;14;CPExpression.jt;31334;
...
{ with(self)
{
    ...
    while (YES)
    {
        ...
        else if (objj_msgSend(self, "scanString:intoString:", "[", NULL))
        {
            ...
            {
                var integer;
                if (objj_msgSend(self, "scanInt:", function(newValue){ var oldValue = integer; if (typeof newValue != 'undefined') integer = newValue; return oldValue;}))
                    left = objj_msgSend(CPExpression, "expressionForFunction:arguments:", "fromObject:index:", objj_msgSend(CPArray, "arrayWithObjects:", left, objj_msgSend(CPExpression, "expressionForConstantValue:", integer)));
            }
            if (!objj_msgSend(self, "scanString:intoString:", "]", NULL))
